...
*   変更内容       ：                                                  *
************************************************************************
CLASS zcl_bp_supporgtxt DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    TYPES:
      BEGIN OF gts_param_supporgtxt,
        value1 TYPE string,
        value2 TYPE string,
      END   OF gts_param_supporgtxt.

    TYPES:
      BEGIN OF gts_return_supporgtxt,
        Status                        TYPE string,
        Message                       TYPE string,
      ...
      END   OF gts_return_supporgtxt,
      gtt_return_supporgtxt TYPE STANDARD TABLE OF gts_return_supporgtxt.
    ...
    CLASS-METHODS:
      ...
      "一般データ
      get_url_supporgtxt RETURNING VALUE(edf_url) TYPE string,

      get_param_supporgtxt
        IMPORTING is_parameter TYPE gts_param_supporgtxt
      ...
      get_data_supporgtxt
        ...
        EXPORTING ef_status    TYPE string
                  ...
                  et_return    TYPE gtt_return_supporgtxt
        RAISING   cx_http_dest_provider_error,

      get_results_api_supporgtxt
        IMPORTING if_json_data      TYPE string
                  is_parameter      TYPE gts_param_supporgtxt
        EXPORTING et_return         TYPE gtt_return_supporgtxt
        RETURNING VALUE(ef_message) TYPE string
        .
...
CLASS ZCL_BP_SUPPORGTXT IMPLEMENTATION.
  ...
  METHOD do.
    DATA:
      ...
      lds_parameter   TYPE gts_param_supporgtxt,
      lds_return      TYPE zcl_bp_supporgtxt=>gts_return_supporgtxt,
      ldt_return      TYPE zcl_bp_supporgtxt=>gtt_return_supporgtxt.
...
*      WITH is_parameter-value4.
  ...
  METHOD get_results_api_supporgtxt.
    ...
    DATA:
      lds_return     TYPE gts_return_supporgtxt,
    ...
    LOOP AT lds_api_return-d-results INTO DATA(lds_results).
      ...
      lds_return-PurchasingOrganization = is_parameter-value2.
  ...
  METHOD get_url_supporgtxt.
    ...
    "https://my418619-api.s4hana.cloud.sap/sap/opu/odata/sap/API_BUSINESS_PARTNER/A_SupplierPurchasingOrg(Supplier='12345TEST',PurchasingOrganization='100')/to_PurchasingOrgText
    edf_url =
      |https://{ ldf_client }-api.{ ldf_url }:443/sap/opu/odata/sap/API_BUSINESS_PARTNER/A_SupplierPurchasingOrg(Supplier='&1',PurchasingOrganization='&2')/to_PurchasingOrgText|.
  ENDMETHOD.
